...
const CategoryDrawerRow = forwardRef<HTMLButtonElement, CategoryDrawerRowProps>(
  function CategoryDrawerRow({ label, count, active, onSelect }, ref) {
    const base =
...
export default CategoryDrawerRow;
